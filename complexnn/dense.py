...
class QuaternionDense(Layer):
    ...
    def build(self, input_shape):
        ...
        input_dim = tensor_shape.dimension_value(input_shape[-1] // 4)
        ...
        self.input_spec = InputSpec(min_ndim=2, axes={-1: 4 * input_dim})
        self.built = True
    ...
    def call(self, inputs):
        ...
        if rank == 2 or rank is None:
            ...
            output = standard_ops.tensordot(inputs, cat_kernels_4_quaternion, [[rank - 1], [0]])
